...
<section class="section">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('responses.show', $response['id']) }}" class="btn btn-primary btn-sm" title="Show"><i class="bi bi-eye"></i></a>
            </div>
        </div>
    ...
    @endforeach
    <div>{!! $responses->appends(['sort' => 'created_at'])->links() !!}</div>
</section>
@endsection